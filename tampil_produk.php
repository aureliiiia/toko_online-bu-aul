        ...
        $qry_produk = mysqli_query($conn, "select * from produk");
                ...
                while($data_produk=mysqli_fetch_array($qry_produk)){
                    ...
                    <tr>
                        ...
                        <td><?="<img src='images/".$data_produk['foto_produk']."'style='width:150px; height: 100px;'>"?></td>
                        <td><a href="ubah_produk.php?id_produk=<?=$data_produk['id_produk']?>" class="btn btn-success">Ubah</a> | <a href="hapus_produk.php?id_produk=<?=$data_produk['id_produk']?>" onclick="return confirm('Apakah anda yakin akan menghapus data ini?')" class="btn btn-danger">Hapus</a></td>
                    </tr>
                <?php
                }
                ?>
