...
<body>
        ...
        $qry_petugas = mysqli_query($conn, "select * from petugas");
                ...
                while($data_petugas=mysqli_fetch_array($qry_petugas)){
                    ...
                    <tr>
                        ...
                        <td><a href="ubah_petugas.php?id_petugas=<?=$data_petugas['id_petugas']?>" class="btn btn-success">Ubah</a> | <a href="hapus_petugas.php?id_petugas=<?=$data_petugas['id_petugas']?>" onclick="return confirm('Apakah anda yakin akan menghapus data ini?')" class="btn btn-danger">Hapus</a></td>
                    </tr>
                <?php
                }
                ?>
   ...
   <a href="tambah_petugas.php" class="btn btn-success">Tambah Petugas</a>
